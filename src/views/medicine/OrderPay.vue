...
import { ref } from 'vue'
import type { OrderPre, Address } from '@/types/medicine'
import { getMedicalOrderPre, getAddressList, createMedicalOrder } from '@/api/medicine'
 ...
 */
// 生成订单
const agree = ref(false) //支付协议勾选
const loading = ref(false) //重复点击
// 控制抽屉和弹窗
